...
try {
    ...
    // Validate quantity (0 is allowed to remove item)
    if ($quantity < 0) {
        ob_clean();
        echo json_encode([
            'success' => false,
    ...
    // Note: If quantity is 0, the controller will automatically remove the item
    ...
    // Log the error
    error_log("Error in update_quantity_action.php: " . $e->getMessage());
